...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.format) return 'No tiene el formato requerido';
    if (displayError == StockError.value) return 'Stock debe ser un numero mayor o igual a 0';
  ...
  StockError? validator(int value) {
    ...
    final isInt = int.tryParse(value.toString()) ?? -1;

    if (isInt == -1) return StockError.format;
